<script>
  ...
  const PANEL_TYPES = [
    ...
    { type: "top_hung", label: "Klapraam", icon: "KL", color: "#22D3EE", dir: "outward" },
    { type: "bottom_hung", label: "Tuimelraam", icon: "TU", color: "#2DD4BF", dir: "inward" },
    { type: "sliding", label: "Schuifraam", icon: "S", color: "#34D399" },
    { type: "lift_slide", label: "Hefschuif", icon: "HS", color: "#10B981" },
    { type: "pivot", label: "Pivot", icon: "PV", color: "#A78BFA", dir: "inward" },
